...
public class ConsumerController {
    ...
    public String branch() {
        ...
        com.mockuai.wdzg.clubcenter.common.api.helper.Response<ConditionDTO> conditionDTOResponse = conditionService.getCondition(new ConditionQTO(), com.mockuai.wdzg.clubcenter.common.api.helper.CallerInfo.getInstance("sssss"));
