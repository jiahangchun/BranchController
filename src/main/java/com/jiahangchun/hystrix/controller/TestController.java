//package com.jiahangchun.hystrix.controller;
//
...
// * @author chunchun
// * @descritpion
// * @date Created at 2019/1/24 下午2:16
// **/
...
//            })
//    public Result getOrderPageList(@RequestBody PaginationQuery query) {
//        //do something
//    }
//
//    public Result getOrderPageListFallback(@RequestBody PaginationQuery query){
//        logger.error("===================== 执行降级策略");
